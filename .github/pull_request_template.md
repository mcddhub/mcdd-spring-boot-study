<!--
Thanks for contributing to us. Please review the following notes before
...
Also make sure that your new module has the appropriate documentation under `./docs/`
